...
### **Frontend**
*   **Framework**: [Flutter](https://flutter.dev/) para una experiencia multiplataforma (Web, Android, iOS) fluida y moderna.
*   **Cámara & Archivos**: Integración con plugins nativos para captura de fotos y selección de documentos.
...
├── smartbudget_front/          # 📱 Aplicación Web/Móvil (Flutter)
│   ├── lib/                    # Código fuente principal
│   │   ├── core/               # Constantes, temas y utilidades compartidas
│   │   ├── data/               # Modelos de datos y repositorios de API
│   │   ├── features/           # Módulos por funcionalidad (Auth, Budget, etc.)
